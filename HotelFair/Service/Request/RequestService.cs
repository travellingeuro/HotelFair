...
namespace HotelFair.Service.Request
{
    public class RequestService: IRequestService
    {
        ...
        public async Task<Models.Destinations> GetDestinationsAsync<Destinations>(string uri, string token = "")
        {
            var httpClient = CreateHttpClient(token);
            ...
            var result = await Task.Run(() => Models.Destinations.FromJson(serialized));
